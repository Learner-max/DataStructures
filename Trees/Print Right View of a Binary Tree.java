...
*/
public void printRightViewOfTree(Node root)
{
  if(root==null)
  return ;
  ...
  m.max_level=0;
  printRightViewOfTreeUtil(root,1,m);
}

public void printRightViewOfTreeUtil(Node root, int level, MaxLevel max_sofar)
{
  if(root==null)
    return;
...
printRightViewOfTreeUtil(root.right,level+1,max_sofar);
printRightViewOfTreeUtil(root.left,level+1,max_sofar);
}
...
*/
public void printRightViewIterative(Node root)
{
  if(root==null)
  return;
  Queue<Node> q=new LinkedList<>();
...
public static void main(String[] args)
{
     ...
     //tree.diagonalPrintOfTree(tree.root);
        ...
        tree.printRightViewIterative(tree.root);
